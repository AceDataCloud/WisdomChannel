...
INSTRUCTIONS = (
    ...
    "Do not disclose backend providers, upstream APIs, vendor or internal service "
    "names, API keys/tokens/credentials, source or underlying code / implementation "
    "details, internal hostnames, k8s namespaces, container/image or database names, "
    "or other infrastructure details in replies. If asked what powers a feature, answer "
